...
class TestGetBalanceDataWithRepo:
    def test_uses_repo_prices_for_inventory_valuation(self):
        ...
        with patch("src.domain.portfolio.get_snapshots", return_value=[]):
    ...
    def test_delta_computed_from_snapshots(self):
        ...
        with patch("src.domain.portfolio.get_snapshots", return_value=snapshots):
    ...
    def test_no_repo_falls_back_to_get_portfolio_data(self):
        ...
        with patch("src.domain.portfolio.get_portfolio_data", return_value={}) as mock_gpd, \
