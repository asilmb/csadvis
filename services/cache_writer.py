...
def _fetch_order_book_data(
    ...
    from engine.wall_filter import compute_wall_metrics, get_best_buy_order  # noqa: F401
    from ingestion.nameid_cache import load_nameid_cache, save_nameid_cache
...
def refresh_cache(db: Session) -> None:
    ...
    from database.models import DimContainer, DimUserPosition, FactContainerPrice
